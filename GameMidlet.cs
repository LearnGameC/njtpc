...
public class GameMidlet
{
	...
	public GameMidlet()
	{
		...
		Debug.Log((object)("AGENT: " + clientAgent + ", PROVIDER: " + userProvider));
	...
	public string readFileText(string fileName)
	{
		...
		try
		{
			...
			TextAsset val = (TextAsset)Resources.Load(Main.res + "/" + fileName, typeof(TextAsset));
			stringReader = new StringReader(val.text);
